                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-1/3 space-y-4 md:border-r-2 md:border-teal-500 pr-4">
                                ...
                                <>
                                    ...
                                    {clientsLoading ? (
                                        ...
                                        <ul className="max-h-32 overflow-y-auto">
                                            {clients
                                                .filter((c) => c.name.toLowerCase().includes(client.toLowerCase()))
                                                .map((c) => (
                                                    <li
                                                        key={c.phone}
                        ...
                        <div className="flex justify-between mt-4">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 w-full ml-2 rounded text-white ${loading || clientsLoading ? "bg-blue-300 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"}`}
                    ...
                    <div className="md:w-2/3 pl-2 mt-4 md:mt-0 ">
                        ...
                        <div className="text-sm text-gray-500">
                            This call will be booked for the above slot if it doesn't overlap
                            with another.
                        </div>
                    </div>
                </div>
